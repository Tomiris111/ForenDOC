...
rf_model = joblib.load("rf_encryption_model.pkl")                         # Random Forest for encryption detection
bilstm_encryption_model = load_model("bilstm_encryption_model_v2.keras")  # BiLSTM for encryption detection
bilstm_classifier_model = load_model("bilstm_topic_classifier.keras")     # BiLSTM for topic classification
